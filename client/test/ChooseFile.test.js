...
function testRender() {
    ...
    let expectedButtonTexts = ['Search for locations', 'Filter Your Search', 'Search', 'Add destination to Trip', 'Add all destinations to Trip', ' Add your own location ', 'Add to trip'];
